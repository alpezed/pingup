...
function StoryItem({ story }: { story: Story }) {
  return (
    <div
      className={cn(
        "relative rounded-lg shadow min-w-30 h-full max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 active:scale-95",
  ...
  return (
    <Dialog open={open}>
      ...
      <DialogContent
        ...
        className="bg-transparent border-0 shadow-none text-white w-[448px] p-0 sm:max-w-xl my-2"
      >
